    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(string Username, string Password, string Email)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var message = new Message(new string[] { user.Email! }, "Xác nhận tài khoản - PhoneShop", confirmationLink!);
                _emailService.SendEmail(message); if (!await _roleManager.RoleExistsAsync("User"))
